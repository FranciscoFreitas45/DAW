...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <xsl:result-document href="html/index.html">
            <html>
                ...
                <body>
                    <h1>Arquivo do Arqueossítios do Nordeste Português</h1>
    ...
    <xsl:template match="ARQELEM" mode="indice">
        <li>
            <a name="{generate-id()}"/>
            <a href="arqssitio-{generate-id()}.html"><xsl:value-of select="IDENTI"/></a>
        </li>
        </xsl:template>
    
    
    <xsl:template match="ARQELEM">
        <xsl:result-document href="html/arqssitio-{generate-id()}.html">
            <html>
                <head>
                    <title>>Arquivo do Arqueossítios do Nordeste Português</title>
                    <meta charset="UFT8"/>
                ...
                <body>
                    <table>
                        ...
                        <tr>
                            <th>Bibliografica</th><td><xsl:value-of select="BIBLIO"/></td>
                        </tr>
